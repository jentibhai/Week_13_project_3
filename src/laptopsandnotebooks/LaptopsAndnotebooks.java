...
public class LaptopsAndnotebooks extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        verifyText("Success: You have added MacBook to your shopping cart!", (By.xpath("//div[@class='alert alert-success alert-dismissible']")), "Message not verified");
        ...
        verifyText("Success: You have modified your shopping cart!", (By.xpath("//div[@class='alert alert-success alert-dismissible']")), "");
        ...
        sendTextToElement(By.id("input-payment-firstname"), "njh");
        sendTextToElement(By.id("input-payment-lastname"), "kjh");
        sendTextToElement(By.id("input-payment-email"), "jkhg@gmail.com");
        ...
        selectByVisibleTextFromDropDown(By.id("input-payment-country"), "jkhgf ghgg");
        ...
        verifyText("Warning: Payment method required!", (By.xpath("//div[@class='alert alert-danger alert-dismissible']")), "");
    }
