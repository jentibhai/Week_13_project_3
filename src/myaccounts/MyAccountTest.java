...
import static browsertesting.BaseTest.driver;
...
public class MyAccountTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-firstname"), "kjh");

        //3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "jhg");
        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "jhg@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "7896754");
        //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "kjht123");
        //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "kjh123");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        //4.5 Enter Password
        sendTextToElement(By.id("input-password"), "kjh123");
